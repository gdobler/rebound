...
# global variables
INPUT_PATH = os.path.join(os.environ['REBOUND_DATA'], 'bb', '2017')
GOWANUS_BB_LABELS = np.load(os.path.join(os.environ['REBOUND_WRITE'],'final','gowanus_labels.npy'))
...
def get_curves(month, night, output_dir, file_start=100, file_stop=2700, step=6, create_ts_cube=False):
    ...
    if output_dir != None:
        ...
        np.save(os.path.join(
            output_dir, 'lightcurves_{}_{}.npy'.format(month, night)), ts_array)
