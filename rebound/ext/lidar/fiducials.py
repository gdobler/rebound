...
def get_ldr_fid(image):
	...
	if image == 'bk':
		ldr_fid = np.array([[9.87858446e+05, 1.89366284e+05, 8.31800000e+01],
      				    [9.87851166e+05, 1.84582434e+05, 1.18858491e+02],
      				    [9.87753166e+05, 1.88285434e+05, 1.37124184e+02],
      				   # [9.86039166e+05, 1.83084434e+05, 3.20000000e+01],
      				   # [9.87241166e+05, 1.88546434e+05, 6.50000000e+01],
      				    [9.87414166e+05, 1.88864434e+05, 6.78373930e+01],
      				    [9.87556166e+05, 1.88604434e+05, 1.04578634e+02],
      				    [9.87671816e+05, 1.89426084e+05, 8.31800000e+01],
      				    [9.87855866e+05, 1.89793684e+05, 8.05600000e+01],
      				    [9.87694656e+05, 1.90460144e+05, 1.57284006e+02]])
...
def center_img_fid(dims, img_fid):
	...
	for i in range(np.shape(img_fid)[0]):
		...
		center_fid[i, 1] = (dims[1] / 2) - img_fid[i, 1]
